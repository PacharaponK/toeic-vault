...
### แสดงความขัดแย้ง (Contrast)
| Conjunction | ความหมาย | ตัวอย่าง |
|-------------|----------|---------|
| **although / even though / though** | แม้ว่า | **Although** costs rose, profits increased. |
| **while / whereas** | ในขณะที่ / แต่ | Sales rose **while** expenses fell. |
...
1. The new software is user-friendly _______ it takes time to learn all features.
   **(A) however (B) although (C) yet (D) despite**
   → **C** (yet = conjunction เชื่อม 2 clauses; although ก็ได้แต่ต้องเป็นต้น clause)

2. _______ the proposal was submitted late, the committee agreed to review it.
   **(A) Despite (B) However (C) Although (D) Nevertheless**
   → **C** (Although + clause)

3. Please notify HR _______ you decide to accept or decline the offer.
   **(A) whether (B) if (C) either (D) unless**
   → **A** (whether...or not)

4. The expansion plan will proceed _______ all shareholders approve it.
   **(A) provided that (B) despite (C) however (D) so that**
   → **A** (provided that = โดยมีเงื่อนไขว่า)

5. _______ the merger was announced, stock prices rose sharply.
   **(A) Once (B) Despite (C) However (D) But**
   → **A** (Once = ทันทีที่)
